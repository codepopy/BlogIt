...
<%   
   ...
   int a = Integer.parseInt(request.getParameter("post_id"));
   PostsEntity p = dao.getPostByPostId(a);
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body class="bg-dark">
        ...
        <div class="container w-75 pt-3" >
            ...
            <form id="addPostForm" action="editPostServlet" method="POST" enctype="multipart/form-data">
                <div class="mb-3">

                    <select class="form-select scroll-bar text-light bg-dark border-danger" name="category_id" value>
                        
                        <option select value="<%=p.getCategory_id()%>" selected><%=dao.getCategoryById(p.getCategory_id())%></option>
                        <% 
                ...
                <div class="mb-3">
                    ...
                    <input name="post_title" type="text" autocomplete="off" class="form-control form-control-lg fs-1 serif_font bg-dark text-light border-0 plc" id="PostTitle" placeholder="Title" value="<%=p.getPost_title()%>">

                </div>
                <div class="mb-3">

                    <input name="post_description" autocomplete="off" type="text" class="form-control form-control-lg fs-3 serif_font bg-dark text-light border-0 plc" id="PostDesc" placeholder="Description.." value="<%=p.getPost_desc()%>">

                </div>
                <div class="mb-3">

                    <div class="mb-4 d-flex justify-content-center">
                        <img src="images\postImages\<%= p.getPost_pic() %>" class="rounded"
                ...
                <div class="mb-3 serif_para_font">
                    ...
                    <textarea name="post_content" type="textarea" class="form-control fs-4 bg-dark text-light border-0 plc scroll-bar" id="contentInput" placeholder="Tell your story..." style="height:400px;font-family: 'PT Serif', serif" ><%=p.getPost_content()%></textarea>
                </div>
                ...
                $("#addPostForm").on("submit", function (event) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            form.append("post_id",'<%=p.getPost_id()%>');
                            $.ajax({
                                url: "editPostServlet",
                                type: "POST",
                                data: form,
