...
<html>
    ...
    <body class="bg-dark">
        ...
        <div class="container w-75">
            <div class="text-danger display-4 py-2">Saved Posts</div>

            <%
                PostDao dao = new PostDao(ConnectionProvider.getConnection());
                List<PostsEntity> posts = dao.getSavedPostsByUserId(user.getUser_id());
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body my-auto" style="min-height:200px">
                            ...
                            <div class="d-flex">
                                <a href="show_blog.jsp?post_id=<%= p.getPost_id() %>" class="btn btn-danger shadow glitch_font_text fs-5 mx-2">Read More</a>
